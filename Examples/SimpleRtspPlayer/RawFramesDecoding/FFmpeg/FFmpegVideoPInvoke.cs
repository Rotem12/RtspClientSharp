...
namespace SimpleRtspPlayer.RawFramesDecoding.FFmpeg
{
    ...
    static class FFmpegVideoPInvoke
    {
        ...
        [DllImport(LibraryName, EntryPoint = "set_window_hwnd", CallingConvention = CallingConvention.Cdecl)]
        public static extern int SetWindowHwnd(IntPtr handle, out IntPtr d3d11Handle);
