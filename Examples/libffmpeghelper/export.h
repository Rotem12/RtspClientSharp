...
//DllExport(int) set_window_hwnd(void* handle, void** contextHandle);
DllExport(int) create_video_decoder(int codec_id, void **handle);
DllExport(int) create_video_decoder_with_options(int codec_id, int preferHardwareAcceleration, void **handle);
...
DllExport(int) decode_video_frame_padded(void *handle, void *rawBuffer, int rawBufferLength, int *frameWidth, int *frameHeight, int *framePixelFormat);
...
DllExport(int) decode_video_frame_to_gpu_padded(void *handle, void *rawBuffer, int rawBufferLength, int *frameWidth, int *frameHeight, int *framePixelFormat);
